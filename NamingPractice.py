...
def findSubscripts(cation, anion):  #Identify the formula for an ionic compound.  Add '()' around polyatomic ions, if needed.
    if cation[2] == -anion[2]:
...
@app.route('/ffntutorial/<type>',methods=['POST', 'GET'])
