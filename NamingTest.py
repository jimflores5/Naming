...
for x in range(6):
    ...
    if x%2==0:
        message = "Provide the name for "+formula+": "
        answer = input(message)
        if answer.lower() == name.lower():
            print("Correct! :-)")
        else:
            print("Sorry, the correct name was:",name)
    else:
        message = "Provide the formula for "+name+": "
        answer = input(message)
        if answer == formula:
            print("Correct! :-)")
        else:
            print("Sorry, the correct formula was:",formula)